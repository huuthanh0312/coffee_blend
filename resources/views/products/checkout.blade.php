        ...
        <form method="post" action="{{ route('process.checkout')}}" class="billing-form ftco-bg-dark p-3 p-md-5">
            ...
            <div class="row align-items-end">
              ...
              <div class="form-group">
                ...
                <input type="text" name="frist_name" class="form-control" placeholder="">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
          ...
          <div class="w-100"></div>
              ...
              <div class="col-md-12">
                ...
                <textarea cols="10" rows="10" type="text"  name="address" class="form-control" placeholder="House number and street name"></textarea>
              </div>
              </div>
              <!-- <div class="col-md-12">
                  <div class="form-group">
          ...
          <div class="col-md-6">
              <div class="form-group">
                <h4 class="emailaddress">Total Price : {{ Session::get('price') }} </h4>
                <input type="hidden"   name="price" value="{{ Session::get('price') }}" class="form-control" placeholder="">
              </div>
          </div>
          <div class="w-100"></div>
          <div class="col-md-12">
